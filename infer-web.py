...
def change_sr2(sr2, if_f0_3, version19):
    ...
    if not if_pretrained_generator_exist:
        print(
            ...
            "nao existe, nao sera usado modelo pre-treinado",
        )
            ...
            with gr.Group():
                ...
                with gr.Row():
                    ckpt_a = gr.Textbox(
                        ...
                        value="",
                        interactive=True,
                        placeholder=i18n("Path to your model A."),
                    )
                    ckpt_b = gr.Textbox(
                        label=i18n("B模型路径"),
                        value="",
                        interactive=True,
                        placeholder=i18n("Path to your model B."),
                    )
                    alpha_a = gr.Slider(
                        minimum=0,
                        maximum=1,
            ...
            with gr.Group():
                ...
                with gr.Row(): ######
                    ckpt_path0 = gr.Textbox(
                        label=i18n("模型路径"),
                        placeholder=i18n("Path to your Model."),
                        value="",
                        interactive=True,
                    )
                    info_ = gr.Textbox(
                        ...
                        max_lines=8,
                        interactive=True,
                        placeholder=i18n("Model information to be changed.")
                    )
            ...
            with gr.Group():
                ...
                with gr.Row():
                    ckpt_path1 = gr.Textbox(
                        ...
                        value="",
                        interactive=True,
                        placeholder=i18n("Model path here.")
                    )
            ...
            with gr.Group():
                ...
                with gr.Row():
                    ...
                    info___ = gr.Textbox(
                        ...
                        max_lines=8,
                        interactive=True,
                        placeholder=i18n("Model info here."),
                    )
        ...
        with gr.TabItem(i18n("Onnx导出")):
            with gr.Row():
                ckpt_dir = gr.Textbox(
                    ...
                    value="",
                    interactive=True,
                    placeholder=i18n("RVC model path."),
                )
            with gr.Row():
                onnx_dir = gr.Textbox(
                    label=i18n("Onnx输出路径"),
                    value="",
                    interactive=True,
                    placeholder=i18n("Onnx model output path."),
                )
            with gr.Row():
